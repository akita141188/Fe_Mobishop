...
const Header = () => {
  ...
  const identifier = customer?.identifier;
        ...
        <div className="container">
          <div className="row">
            <div id="logo" className="col-lg-3 col-md-12 col-sm-12">
              <h1>
                <Link to="/">
                  <img className="img-fluid" src={getImageProduct(configs.logo_footer)} />
                </Link>
              </h1>
            </div>
            ...
            <div id="cart" className="col-lg-5 col-md-12 col-sm-12">
            {
                logged ?
                  <>
                    ...
                    <Link className="mr-2" to="/Customer">{identifier }</Link>|
                    <Link onClick={clickLoggedOut} className="mr-2 ml-2" to="#">đăng xuất</Link>|</>
                  :
                  <>
