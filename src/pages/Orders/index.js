...
import { OrdersCustomer } from "../../services/Api";
            ...
            orders.map((order,index)=>{
                ...
                return (
                    ...
                    <div className="cart-thumb col-lg-7 col-md-7 col-sm-12">
                      <h4>Đơn hàng đã mua vào ngày: <span className="text-secondary">{formatDate(order.createdAt)}</span></h4>
                      <p>Mã Đơn (MĐ):{order._id}</p>
                    </div>
                    <div className="cart-price col-lg-2 col-md-2 col-sm-12"><b>{formatPrice(order.total_price)}</b></div>
